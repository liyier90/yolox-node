...
class Detector:
    ...
    def predict_object_bbox_from_image(self, image, class_names):
        ...
        with torch.no_grad():
            ...
            bboxes, classes, scores = self._postprocess(
                prediction, scale, image_shape, class_names
            )
    ...
    def _postprocess(self, prediction, scale, image_shape, class_names):
        # xywh to xyxy
        ...
        bboxes[:, [0, 2]] /= image_shape[1]
        bboxes[:, [1, 3]] /= image_shape[0]
